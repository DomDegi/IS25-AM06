...
public enum ClientState implements Serializable {
    ...
    public String toString() {
        switch(this) {
            ...
            case S_END_DRAW_TILE_CARD -> {return "Now you can draw a tile or a card [done] [draw tile|draw tile new] [draw tile b1] [draw tile b2] [draw tile turnedTileNum] [draw deck numDeck] [check playerNum] [turn] [buildship] [buildship2]";}
