...
public class ClientController {
    ...
    public void buildShiplv2(){
        ...
        lightShipBoard.positionTile(Optional.ofNullable(tile10), new Coordinates(2,4));
        try {
        ...
        lightShipBoard.positionTile(Optional.ofNullable(tile12), new Coordinates(2,5));
        try {
        ...
        lightShipBoard.positionTile(Optional.ofNullable(tile11), new Coordinates(2,6));
        try {
        ...
        lightShipBoard.positionTile(Optional.of(tile9), new Coordinates(2,2));
        try {
        ...
        lightShipBoard.positionTile(Optional.of(tile15), new Coordinates(3,3));
        try {
        ...
        lightShipBoard.positionTile(Optional.of(tile3), new Coordinates(1,2));
        try {
        ...
        lightShipBoard.positionTile(Optional.of(tile2), new Coordinates(1,1));
        try {
        ...
        lightShipBoard.positionTile(Optional.of(tile8), new Coordinates(2,1));
        try {
        ...
        lightShipBoard.positionTile(Optional.of(tile5), new Coordinates(1,4));
        try {
        ...
        lightShipBoard.positionTile(Optional.of(tile6), new Coordinates(1,5));
        try {
        ...
        lightShipBoard.positionTile(Optional.of(tile7), new Coordinates(2,0));
        try {
        ...
        lightShipBoard.positionTile(Optional.of(tile13), new Coordinates(3,0));
        try {
        ...
        lightShipBoard.positionTile(Optional.of(tile14), new Coordinates(3,2));
        try {
        ...
        lightShipBoard.positionTile(Optional.of(tile16), new Coordinates(3,4));
        try {
        ...
        lightShipBoard.positionTile(Optional.of(tile17), new Coordinates(3,5));
        try {
        ...
        lightShipBoard.positionTile(Optional.of(tile18), new Coordinates(3,6));
        try {
        ...
        lightShipBoard.positionTile(Optional.of(tile19), new Coordinates(4,0));
        try {
        ...
        lightShipBoard.positionTile(Optional.of(tile20), new Coordinates(4,1));
        try{
        ...
        lightShipBoard.positionTile(Optional.of(tile21), new Coordinates(4,2));
        try {
        ...
        tile22.rotate();
        tile22.rotate();
        lightShipBoard.positionTile(Optional.of(tile22), new Coordinates(4,4));
        try {
        ...
        lightShipBoard.positionTile(Optional.of(tile1), new Coordinates(0,4));
        try {
