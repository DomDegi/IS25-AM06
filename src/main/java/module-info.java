module it.polimi.ingsw.galaxytruckerproject {
    ...
    exports it.polimi.ingsw.galaxytruckerproject.controller.client;
    opens it.polimi.ingsw.galaxytruckerproject.controller.client to com.fasterxml.jackson.databind;
}