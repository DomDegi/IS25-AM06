...
class ShipBoardTest {
    ...
    void testOneTileCorrectShipboard() {
        Tile tile=new DoubleEngine(new Link(Connectors.SMOOTH),new Link(Connectors.DOUBLE),new Link(Connectors.SMOOTH),new Link(Connectors.SMOOTH),0);
    ...
    void testTwoTilesConnectorsShipboardWithRotation() {
        //create e set tile 1
        Tile tile1=new DoubleCannon(new Link(Connectors.SMOOTH),new Link(Connectors.UNIVERSAL),new Link(Connectors.SMOOTH),new Link(Connectors.UNIVERSAL),0);
        tile1.rotate();
        shipBoard.positionTile(Optional.of(tile1), new Coordinates(3,3));
        //create e set tile 2
        Tile tile2=new Pipe(new Link(Connectors.SMOOTH),new Link(Connectors.DOUBLE),new Link(Connectors.UNIVERSAL),new Link(Connectors.SMOOTH),0);
    ...
    void testTwoTilesWrongConnectorsShipboardWithRotation() {
        //create e set tile 1
        Tile tile1=new DoubleCannon(new Link(Connectors.SMOOTH),new Link(Connectors.SMOOTH),new Link(Connectors.SMOOTH),new Link(Connectors.SMOOTH),0);
        tile1.rotate();
        shipBoard.positionTile(Optional.of(tile1), new Coordinates(3,3));
        //create e set tile 2
    ...
    void testOneCannonStrength(){
        Tile tile1=new SingleCannon(new Link(Connectors.SMOOTH),new Link(Connectors.UNIVERSAL),new Link(Connectors.SMOOTH),new Link(Connectors.UNIVERSAL),0);
        tile1.rotate();
        shipBoard.positionTile(Optional.of(tile1), new Coordinates(3,3));
    ...
    void testOneBatteryComponent(){
        Tile tile1=new BatteryComponents(new Link(Connectors.DOUBLE),new Link(Connectors.UNIVERSAL),new Link(Connectors.SMOOTH),new Link(Connectors.UNIVERSAL),0, 2);
        tile1.rotate();
        shipBoard.positionTile(Optional.of(tile1), new Coordinates(3,3));
        shipBoard.verifyCorrectness();
    ...
    void testShipboard3ExposedConnectors(){
        ...
        shipBoard1.positionTile(Optional.of(tile6), new Coordinates(3,4));
        shipBoard1.countExposedConnectors();
        assertEquals(8, shipBoard1.getNumExposedConnectors());
    }
    ...
    void testShipboard5ExposedConnectors(){
        ...
        shipBoard1.positionTile(Optional.of(tile22), new Coordinates(4,4));
        shipBoard1.countExposedConnectors();
        assertEquals(7, shipBoard1.getNumExposedConnectors());
    }
    ...
    void gainGoods_correctly(){
        ...
        assertEquals(goods.getFirst().getColor(),shipBoard1.getSingleCargoGoods(new Coordinates(1,3)).getFirst().getColor());
        assertEquals(goods.get(1).getColor(),shipBoard1.getSingleCargoGoods(new Coordinates(1,3)).get(1).getColor());
