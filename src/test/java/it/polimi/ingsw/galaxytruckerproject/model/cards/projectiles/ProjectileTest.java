...
class ProjectileTest {
    ...
    void setUp() {
        ...
        Tile tile2=new SingleCannon( new Link(Connectors.SMOOTH),new Link(Connectors.SINGLE),new Link(Connectors.UNIVERSAL),new Link(Connectors.SMOOTH),0);
        shipBoard1.positionTile(Optional.of(tile2), new Coordinates(1,4));
        Tile tile3=new SingleCannon( new Link(Connectors.SMOOTH),new Link(Connectors.SINGLE),new Link(Connectors.UNIVERSAL),new Link(Connectors.DOUBLE),0);
        tile3.rotate();
        shipBoard1.positionTile(Optional.of(tile3), new Coordinates(2,5));
        Tile tile4=new Pipe( new Link(Connectors.UNIVERSAL),new Link(Connectors.SINGLE),new Link(Connectors.DOUBLE),new Link(Connectors.UNIVERSAL),0);
        shipBoard1.positionTile(Optional.of(tile4), new Coordinates(2,4));
        Tile tile5=new SingleCannon( new Link(Connectors.SMOOTH),new Link(Connectors.SMOOTH),new Link(Connectors.SINGLE),new Link(Connectors.SMOOTH),0);
        tile5.rotate();
        tile5.rotate();
        tile5.rotate();
        shipBoard1.positionTile(Optional.of(tile5), new Coordinates(2,2));
        Tile tile6=new SingleEngine( new Link(Connectors.DOUBLE),new Link(Connectors.SMOOTH),new Link(Connectors.SMOOTH),new Link(Connectors.SMOOTH),0);
        ...
        Tile tile7=new SingleCannon( new Link(Connectors.SMOOTH),new Link(Connectors.SMOOTH),new Link(Connectors.DOUBLE),new Link(Connectors.SMOOTH),0);
        shipBoard2.positionTile(Optional.of(tile7), new Coordinates(0,4));
        Tile tile8=new EquipCabin( new Link(Connectors.SMOOTH),new Link(Connectors.DOUBLE),new Link(Connectors.UNIVERSAL),new Link(Connectors.SINGLE),0);
        shipBoard2.positionTile(Optional.of(tile8), new Coordinates(1,1));
        tile8.setCrewType(CrewType.HUMAN);
        Tile tile9=new AlienLifeSupportsSystem( new Link(Connectors.SMOOTH),new Link(Connectors.SMOOTH),new Link(Connectors.SINGLE),new Link(Connectors.UNIVERSAL),0,CrewType.BROWN);
        shipBoard2.positionTile(Optional.of(tile9), new Coordinates(1,2));
        Tile tile10=new CargoBlue(3, new Link(Connectors.DOUBLE),new Link(Connectors.SINGLE),new Link(Connectors.SINGLE),new Link(Connectors.SMOOTH),0);
        shipBoard2.positionTile(Optional.of(tile10), new Coordinates(1,3));
        Tile tile11=new CargoBlue(3, new Link(Connectors.DOUBLE),new Link(Connectors.DOUBLE),new Link(Connectors.SMOOTH),new Link(Connectors.SINGLE),0);
        shipBoard2.positionTile(Optional.of(tile11), new Coordinates(1,4));
        Tile tile12=new SingleCannon( new Link(Connectors.SMOOTH),new Link(Connectors.SMOOTH),new Link(Connectors.SMOOTH),new Link(Connectors.DOUBLE),0);
        shipBoard2.positionTile(Optional.of(tile12), new Coordinates(1,5));

        Tile tile13=new DoubleCannon( new Link(Connectors.SMOOTH),new Link(Connectors.SINGLE),new Link(Connectors.UNIVERSAL),new Link(Connectors.SMOOTH),0);
        shipBoard2.positionTile(Optional.of(tile13), new Coordinates(2,0));
        Tile tile14=new EquipCabin( new Link(Connectors.DOUBLE),new Link(Connectors.SMOOTH),new Link(Connectors.DOUBLE),new Link(Connectors.SINGLE),0);
        shipBoard2.positionTile(Optional.of(tile14), new Coordinates(2,1));
        tile14.setCrewType(CrewType.HUMAN);
        Tile tile15=new EquipCabin( new Link(Connectors.UNIVERSAL),new Link(Connectors.DOUBLE),new Link(Connectors.DOUBLE),new Link(Connectors.SMOOTH),0);
        shipBoard2.positionTile(Optional.of(tile15), new Coordinates(2,2));
        tile15.setCrewType(CrewType.HUMAN);
        Tile tile16=new Shields( new Link(Connectors.SMOOTH),new Link(Connectors.DOUBLE),new Link(Connectors.DOUBLE),new Link(Connectors.UNIVERSAL),0);
        shipBoard2.positionTile(Optional.of(tile16), new Coordinates(2,4));
        Tile tile17=new EquipCabin( new Link(Connectors.SMOOTH),new Link(Connectors.SINGLE),new Link(Connectors.SINGLE),new Link(Connectors.UNIVERSAL),0);
        shipBoard2.positionTile(Optional.of(tile17), new Coordinates(2,5));
        tile17.setCrewType(CrewType.HUMAN);
        Tile tile18=new DoubleCannon( new Link(Connectors.SMOOTH),new Link(Connectors.SMOOTH),new Link(Connectors.SINGLE),new Link(Connectors.UNIVERSAL),0);
        shipBoard2.positionTile(Optional.of(tile18), new Coordinates(2,6));

        Tile tile19=new BatteryComponents( new Link(Connectors.DOUBLE),new Link(Connectors.UNIVERSAL),new Link(Connectors.DOUBLE),new Link(Connectors.DOUBLE),0, 2);
        shipBoard2.positionTile(Optional.of(tile19), new Coordinates(3,0));
        Tile tile20=new EquipCabin( new Link(Connectors.DOUBLE),new Link(Connectors.SMOOTH),new Link(Connectors.UNIVERSAL),new Link(Connectors.SMOOTH),0);
        shipBoard2.positionTile(Optional.of(tile20), new Coordinates(3,2));
        tile20.setCrewType(CrewType.HUMAN);
        Tile tile21=new SingleEngine( new Link(Connectors.DOUBLE),new Link(Connectors.UNIVERSAL),new Link(Connectors.SMOOTH),new Link(Connectors.SMOOTH),0);
        shipBoard2.positionTile(Optional.of(tile21), new Coordinates(3,3));
        Tile tile22=new CargoRed(1, new Link(Connectors.DOUBLE),new Link(Connectors.UNIVERSAL),new Link(Connectors.DOUBLE),new Link(Connectors.DOUBLE),0);
        shipBoard2.positionTile(Optional.of(tile22), new Coordinates(3,4));
        Tile tile23=new DoubleEngine( new Link(Connectors.UNIVERSAL),new Link(Connectors.SMOOTH),new Link(Connectors.SMOOTH),new Link(Connectors.DOUBLE),0);
        shipBoard2.positionTile(Optional.of(tile23), new Coordinates(3,5));
        Tile tile24=new BatteryComponents( new Link(Connectors.UNIVERSAL),new Link(Connectors.SMOOTH),new Link(Connectors.SMOOTH),new Link(Connectors.SMOOTH),0, 2);
        shipBoard2.positionTile(Optional.of(tile24), new Coordinates(3,6));

        Tile tile25=new BatteryComponents( new Link(Connectors.UNIVERSAL),new Link(Connectors.UNIVERSAL),new Link(Connectors.SMOOTH),new Link(Connectors.SMOOTH),0, 2);
        shipBoard2.positionTile(Optional.of(tile25), new Coordinates(4,0));
        Tile tile26=new SingleCannon(new Link(Connectors.SMOOTH),new Link(Connectors.UNIVERSAL),new Link(Connectors.SMOOTH),new Link(Connectors.SINGLE),0);
        shipBoard2.positionTile(Optional.of(tile26), new Coordinates(4,1));
        Tile tile27=new DoubleEngine( new Link(Connectors.SINGLE),new Link(Connectors.SINGLE),new Link(Connectors.SMOOTH),new Link(Connectors.SINGLE),0);
        shipBoard2.positionTile(Optional.of(tile27), new Coordinates(4,2));
        Tile tile28=new SingleCannon( new Link(Connectors.SMOOTH),new Link(Connectors.SMOOTH),new Link(Connectors.UNIVERSAL),new Link(Connectors.DOUBLE),0);
        tile28.rotate();
        tile28.rotate();
