...
class EpidemicTest {
    ...
    void successfully_initialize_card_and_execute () {
        ...
        int player1TotalCrew = player1.getTotalCrew();
        int player2TotalCrew = player2.getTotalCrew();
        int player3TotalCrew = player3.getTotalCrew();

        game.getDrawnCard().initializeCard(game, viewMap);

        assertEquals(player1TotalCrew - 5, player1.getTotalCrew());
        assertEquals(player2TotalCrew - 2, player2.getTotalCrew());
        assertEquals(player3TotalCrew, player3.getTotalCrew());
